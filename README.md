...
1. Include a highlightjs CSS file in your layout manually (see example [here](https://highlightjs.org/download/) ). If you use this method then don't add highlightjs to your options in the gruntfile or it will run twice and generate warnings.
